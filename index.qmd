...
pal <- colorNumeric(
  palette = c("#f2e9e4", "#DCCAC6", "#c9ada7", "#9a8c98", "#4a4e69","#31322e"),
...
[<i class="bi bi-file-code"></i> Repository](https://github.com/zahiernasrudin/dosm_population_dashboard)
:::
:::
